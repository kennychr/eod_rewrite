...
def main():
    ...
    print("""
  ######################################
  # EOD_REWRITE Development Environment Setup #
  ######################################

  This script will create your EOD_REWRITE dev environment for you.
  ...
  This script will create two hard links on your system, both pointing to your EOD_REWRITE project folder:
    [Arma 3 installation directory]\\{} => EOD_REWRITE project folder
    P:\\{}                              => EOD_REWRITE project folder
